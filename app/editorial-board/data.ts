...
export const members: BoardMember[] = [
  ...
  },
  {
    ...
    affiliation: "National Medical Research Center of Coloproctology, Moscow",
    country: "\u{1F1FA}\u{1F1F8}",
    stats: [
    ...
    bio: "Clinical research scientist specializing in inflammatory bowel disease, with over 10 years of experience in clinical trials and observational research. Headed the Scientific Department of Inflammatory and Functional Bowel Diseases at the National Medical Research Center of Coloproctology (2019\u20132025). Principal Investigator for 7 interventional clinical trials in collaboration with global CROs (IQVIA, Parexel, ICON). Published in The Lancet Gastroenterology & Hepatology, Inflammatory Bowel Diseases, Digestive and Liver Disease, and BMC Genomics. MD from Lomonosov Moscow State University (with High Honours); PhD focused on predictors of biologic therapy failure in IBD.",
