...
## ВАЖНО: Проверь перед началом
Проверь, существует ли уже файл public/article-covers/covers/${slug}-cover.png
Если да — спроси пользователя: "Обложка для этой статьи уже существует. Заменить её или оставить текущую?"
Также проверь, есть ли уже блок для ${slug} в public/cover-stock.html (поищи по slug). Если есть — замени его, не дублируй.
