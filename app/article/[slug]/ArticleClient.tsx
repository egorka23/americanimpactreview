...
export default function ArticleClient({ article: raw }: { article: SerializedArticle }) {
  ...
  const rgDirectUrls: Record<string, string> = {
    ...
    "e2026013": "https://www.researchgate.net/publication/401723575",
    "e2026015": "https://www.researchgate.net/publication/401722481",
    "e2026016": "https://www.researchgate.net/publication/401723601",
    ...
    "e2026023": "https://www.researchgate.net/publication/402062417",
  };
      ...
      <header className="plos-hero" ref={heroRef}>
        <div className="plos-hero__main">
          ...
          <div className="plos-hero-top">
            ...
            {article.doi ? <a href={`https://doi.org/${article.doi}`} target="_blank" rel="noopener noreferrer" className="plos-hero-doi"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#F36F21" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg><span><span className="doi-prefix">DOI</span> {article.doi}</span></a> : null}
          </div>
