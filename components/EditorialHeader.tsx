            ...
            >
              ...
              <div className="topbar-panel topbar-panel--about">
                <div className="topbar-group">
                  ...
                  <Link href="/reviewers">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-4-4h-2"/></svg>
                    Peer Reviewers
                  </Link>
